...
agh_help() {
    ...
    echo "  - agh_get_repo_from_dir"
    echo "  - agh_get_repo_name"
    echo "  - agh_get_pr_number_for_branch"
...
alias agh_get_repo_from_dir='get_repo_from_dir'
alias agh_get_repo_name='get_repo_name'
alias agh_get_pr_number_for_branch='get_pr_number_for_branch'
